...
SESSION_ID: process.env.SESSION_ID === undefined ? 'Manu-MD&QPVCiYwR#a2XhkaFkG2VnnMLPDZ5LSmGVSOCTb-8CAm_NdfZKj3I' : process.env.SESSION_ID,
PREFIX: process.env.PREFIX || '.' ,
PORT: process.env.PORT === undefined ? "8000" : process.env.PORT,
SUDO: process.env.SUDO === undefined ? '94778838273' : process.env.SUDO,
